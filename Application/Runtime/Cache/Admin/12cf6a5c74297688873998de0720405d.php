    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">商品管理</h1>
                ...
                <ul class="breadcrumb">
            <li class="active"><a >商品管理</a> <span class="divider">/</span></li>
...
<div class="btn-toolbar">
  ...
  <div class="btn-toolbar">
    <form class="search form-inline" method="GET" action="/index.php/Admin/Goods/lst">
    <input  value="<?php echo ($_GET['goods_name']); ?>" name="goods_name" type="text" placeholder="商品名称">
            <button class="btn">搜索</button>
            <!-- <a href="/index.php/Admin/Goods/lst?goods_category=3" class="btn">未分类</a>
            <a href="/index.php/Admin/Goods/lst?goods_category=1" class="btn">手机</a>
            <a href="/index.php/Admin/Goods/lst?goods_category=2" class="btn">平板</a>
            <a href="/index.php/Admin/Goods/lst?goods_category=0" class="btn">全部</a> -->
    </form>
           
  </div>
</div>
<form method="POST" action="/Admin/Goods/pldelete">
<div class="well">
    <table class="table">
      <thead>
        <tr>
      ...
      <tbody>
          <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
           <td><input type="checkbox" name="goods_id[]" value="<?php echo ($v['goods_id']); ?>"></td>                
          <td><?php echo ($v[goods_id]); ?></td>
          <td><?php echo ($v[goods_name]); ?></td>
          <td><?php echo ($v[goods_category]); ?></td>
          <td><?php echo ($v[goods_price]); ?></td>
          <td><?php echo ($v[goods_number]); ?></td>
          <td><?php echo ($v[goods_introduce]); ?></td>
          <td><img src="/Public/Uploads/<?php echo ($v['goods_small_img']); ?>"></td>
          <td>
              <a href="/index.php/Admin/Goods/edit/id/<?php echo ($v['goods_id']); ?>"><i class="icon-pencil"></i></a>
              <a onclick="return confirm('确定要删除吗？');" href="/index.php/Admin/Goods/delete/goods_id/<?php echo ($v['goods_id']); ?>" role="button"><i class="icon-remove"></i></a>
