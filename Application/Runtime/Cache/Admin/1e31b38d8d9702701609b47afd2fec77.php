            ...
            <form name="myform" id="myform" action="/index.php/Admin/Cate/sort" method="post">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
						...
						<?php if(is_array($catename)): $i = 0; $__LIST__ = $catename;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                ...
                                <a class="link-del" onclick="return confirm('确定删除？')" href="/index.php/Admin/Cate/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
