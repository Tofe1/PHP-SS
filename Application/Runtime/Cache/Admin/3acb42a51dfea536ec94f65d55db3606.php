...
<div class="btn-toolbar">
  ...
  <div class="btn-toolbar">
    <form class="search form-inline" method="GET" action="/Admin/Manager/userlst">
...
<form method="POST" action="/Admin/Manager/userpldelete">
<div class="well">
    <table class="table">
      <thead>
        <tr>
      ...
      <tbody>
          ...
          <td><?php echo ($v[user_relname]); ?></td>
          <td>
              <a href="/index.php/Admin/Manager/useredit/id/<?php echo ($v['user_id']); ?>"><i class="icon-pencil"></i></a>
              <a onclick="return confirm('确定要删除吗？');" href="/index.php/Admin/Manager/userdelete/user_id/<?php echo ($v['user_id']); ?>" role="button"><i class="icon-remove"></i></a>
