...
<div class="sidebar-nav">
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <li><a>修改商品</a> <span class="divider">/</span></li>
...
<div class="well">
    ...
    <form id="tab" action="/index.php/Admin/Goods/doedit" method="POST"  enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo ($info[goods_id]); ?>">
        <input type="hidden" name="name" value="<?php echo ($info[goods_name]); ?>">
        <input type="hidden" name="price" value="<?php echo ($info[goods_price]); ?>">
        <input type="hidden" name="number" value="<?php echo ($info[goods_number]); ?>">
        <input type="hidden" name="introduce" value="<?php echo ($info[goods_introduce]); ?>">
        <input type="hidden" name="obig_img" value="<?php echo ($info['goods_big_img']); ?>">
        <input type="hidden" name="osmall_img" value="<?php echo ($info['goods_small_img']); ?>">
|
        <label>商品名称</label>
        <input value="<?php echo ($info['goods_name']); ?>" type="text" name="goods_name" class="input-xlarge">
        <label>价格</label>
        <input value="<?php echo ($info['goods_price']); ?>" type="text" name="goods_price" class="input-xlarge">
        <label>库存数量</label>
        <input value="<?php echo ($info[goods_number]); ?>" type="text" name="goods_number" class="input-xlarge">
        <label>商品介绍</label>
        <textarea name="goods_introduce" rows="3" class="input-xlarge"><?php echo ($info[goods_introduce]); ?></textarea>
        <div>
        <label>图片</label>
        <input type="file" name="goods_pic" class="input-xlarge">
        <br>
        <img src="/Public/Uploads/<?php echo ($info['goods_small_img']); ?>"
        </div>
