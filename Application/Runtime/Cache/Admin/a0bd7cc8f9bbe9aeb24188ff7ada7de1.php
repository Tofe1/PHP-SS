        ...
        <ul class="sidebar-list">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="/index.php/Admin/Wenz"><i class="icon-font">&#xe005;</i>文章管理</a></li>
                ...
                <form action="" method="post" id="myform" name="myform" >
                    ...
                    <table class="insert-tab" width="100%">
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="id" name="catename" size="50" value="<?php echo ($cater["catename"]); ?>" type="text">
                                </td>
                            </tr>
                            <!-- <tr>
                                <th>作者：</th>
