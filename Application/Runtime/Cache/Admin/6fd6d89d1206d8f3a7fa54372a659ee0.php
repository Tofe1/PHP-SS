...
<head>
    ...
    <script type="text/javascript" src="http://localhost:3000/Application/Admin/Public/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" src="http://localhost:3000/Application/Admin/Public/ueditor/ueditor.all.min.js"></script>
    <script type="text/javascript" src="http://localhost:3000/Application/Admin/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
</head>
<body>
            ...
            <div class="result-content">
                <form action="" method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                            ...
                            <tr>
                                <th><i class="require-red">*</i>文章题目：</th>
                                <td>
                                    <input class="common-text required" id="titl" name="title" size="50" value="" type="text">
                                </td>
                            </tr>
