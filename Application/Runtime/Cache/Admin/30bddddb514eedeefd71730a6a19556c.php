...
<div class="btn-toolbar">
  ...
  <div class="btn-toolbar">
    <form class="search form-inline" method="GET" action="/index.php/Admin/Message/orderlst">
...
<form method="POST" action="/Admin/Message/dpldelete">
<div class="well">
    <table class="table">
      <thead>
        <tr>
      ...
      <tbody>
          ...
          <td><?php echo ($v[goods_zprice]); ?></td>
          <td><img src="/Public/Uploads/<?php echo ($v['goods_small_img']); ?>"></td>
          <td>
              <a onclick="return confirm('确定要删除吗？');" href="/index.php/Admin/Message/ddelete/user_id/<?php echo ($v['user_id']); ?>" role="button"><i class="icon-remove"></i></a>
