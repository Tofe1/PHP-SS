...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/index.php/Admin/Wenz/sort" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/index.php/Admin/Wenz/add"><i class="icon-font"></i>新增文章</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
						...
						<?php if(is_array($articlers)): $i = 0; $__LIST__ = $articlers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/index.php/Admin/Wenz/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确定删除？')" href="/index.php/Admin/Wenz/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
